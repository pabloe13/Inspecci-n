                    ...
                    <div class="row mb-4">
                        <div class="col-12 col-sm-6 col-xl-3 mb-3">
                            <div class="card shadow-sm border-0 border-start border-primary border-4 h-100">
                                <div class="card-body">
                                    <div class="text-muted small fw-bold text-uppercase mb-1">Total Denuncias</div>
                                    <div class="h3 mb-0 fw-bold text-gray-800"><?= number_format($kpis['total']) ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-xl-3 mb-3">
                            <div class="card shadow-sm border-0 border-start border-danger border-4 h-100">
                                <div class="card-body">
                                    <div class="text-muted small fw-bold text-uppercase mb-1">Nuevas (Sin leer)</div>
                                    <div class="h3 mb-0 fw-bold text-gray-800"><?= number_format($kpis['nuevas']) ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-xl-3 mb-3">
                            <div class="card shadow-sm border-0 border-start border-warning border-4 h-100">
                                <div class="card-body">
                                    <div class="text-muted small fw-bold text-uppercase mb-1">En Proceso</div>
                                    <div class="h3 mb-0 fw-bold text-gray-800"><?= number_format($kpis['en_proceso']) ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-xl-3 mb-3">
                            <div class="card shadow-sm border-0 border-start border-success border-4 h-100">
                                <div class="card-body">
                                    <div class="text-muted small fw-bold text-uppercase mb-1">Resueltas</div>
                                    <div class="h3 mb-0 fw-bold text-gray-800"><?= number_format($kpis['resueltas']) ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
